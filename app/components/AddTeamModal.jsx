      ...
      >
        <div className="modal-step">
          ...
          <div style={{maxHeight:'420px', overflowY:'scroll', width: '420px'}}>
            <List>
              <ListItem
                rightToggle={<Checkbox value="Nicky_Cage_ID" onCheck={this.handleCheckboxChange}/>}
                primaryText="Nicky Cage"
                leftAvatar={<Avatar src="https://www.placecage.com/100/100" />}
              />
              <ListItem
                rightToggle={<Checkbox value="Billy_Joel_ID" onCheck={this.handleCheckboxChange}/>}
                primaryText={"Billy Joel"}
                leftAvatar={<Avatar src="https://www.placecage.com/102/101" />}
              />
              <ListItem
                rightToggle={<Checkbox value="Bruce_Willis_ID" onCheck={this.handleCheckboxChange}/>}
