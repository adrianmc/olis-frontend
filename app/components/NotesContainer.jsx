    ...
    return (
      <div id="notes-container">
        ...
        <div className="notes-icon-bar">
          <div className="notes-icon notes-undo"><i className="fa fa-fw fa-undo"></i></div>
          <div className="notes-icon notes-redo"><i className="fa fa-fw fa-undo fa-flip-horizontal"></i></div>
        </div>
      </div>
    );
  }
